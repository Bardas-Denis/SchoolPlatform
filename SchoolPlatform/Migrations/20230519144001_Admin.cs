    ...
    public partial class Admin : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HomeroomTeachers", x => x.HomeroomTeacherId);
                    table.ForeignKey(
                        name: "FK_HomeroomTeachers_People_PersonId",
                        column: x => x.PersonId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Classes_HomeroomTeachers_HomeroomTeacherId",
                        column: x => x.HomeroomTeacherId,
                        principalTable: "HomeroomTeachers",
                        principalColumn: "HomeroomTeacherId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Grades_TeacherSubjects_TeacherSubjectId",
                        column: x => x.TeacherSubjectId,
                        principalTable: "TeacherSubjects",
                        principalColumn: "TeacherSubjectId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Grades_TeacherSubjectId",
                table: "Grades",
                column: "TeacherSubjectId"
               );

            migrationBuilder.CreateIndex(
                name: "IX_HomeroomTeachers_PersonId",
